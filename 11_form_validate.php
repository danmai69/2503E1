...
<body>
    ...
    <form action="11_form_validate.php" method="post">
        <div>
            ...
            <!-- <?php echo $nameErr; ?>: → Nhúng php để in ra nội dung biến $nameErr đã được làm trên php (dùng để báo lỗi). -->
             <!-- span Thẻ dùng để hiển thị nội dung ngắn trên cùng dòng. -->
        </div>
        <div>
